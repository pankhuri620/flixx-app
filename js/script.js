const global = {
  ...
  api: {
    apiKey: '39109369690381fe6fb8b1f8228cc98d',
...
/>`
  ...
  <div>
    ...
    <a href="${show.homepage}" target="_blank" class="btn">Visit Shows Homepage</a>
  </div>
</div>
<div class="details-bottom">
  <h2>Show Info</h2>
...
function displayPagination(){
  ...
  // Disable prev botton if on first page
  if(global.search.page === 1){
    document.querySelector('#prev').disabled = true;
  }

  // Disable next botton if on last page
